...
$output = array();
$query .= "
SELECT * FROM subtblsupplier 
INNER JOIN subtblcategory ON subtblcategory.category_id = subtblsupplier.category_id 
";
...
if(isset($_POST["search"]["value"]))
{
	...
	$query .= 'OR subtblsupplier.brand_status LIKE "%'.$_POST["search"]["value"].'%" ';
}
...
{
	$query .= 'ORDER BY subtblsupplier.brand_id DESC ';
}
...
{
	$statement = $connect->prepare('SELECT * FROM subtblsupplier');
	$statement->execute();
