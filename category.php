    		...
    		<form method="post" id="category_form">
    			<div class="modal-content">
    				<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Add Kind of Parts</h4>
    				</div>
    				<div class="modal-body">
    					<label>Enter Kind of Parts</label>
...
$(document).ready(function(){
	...
	$('#add_button').click(function(){
		...
		$('.modal-title').html("<i class='fa fa-plus'></i> Add Kind of Parts");
		$('#action').val('Add');
		$('#btn_action').val('Add');
	});
