...
?>
                    ...
                    <div class="panel-heading">
                    	<div class="row">
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Low Stock List</h3>
                            </div>
        ...
        <div id="productAddStocksModal" class="modal fade">
            <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                <form method="post" id="frmAddStocks">
                                    ...
                                    <br />
                                    <input type="submit" class="btn btn-primary" style="width: 100%;" id="#add_stocks" value="Add Stocks">
...
$(document).ready(function(){
   ...
   // var productdataTable = $('#product_data').DataTable();
    ...
    $(document).on('click', '.addstocks', function(){
        $('#productAddStocksModal').modal('show');
        var product_id = $(this).attr("id");
    ...
    $(document).on('submit', '#frmAddStocks', function(event){
        event.preventDefault();
        var form_data = $(this).serialize();
        ...
        $.ajax({
                url:"low_action.php",
                method:"POST",
                data:{ prodid:prodid ,sumstocks:sumstocks, btn_action:"add_stocks"},
                success:function(data){
                    $('#alert_action').fadeIn().html('<div class="alert alert-info"><font color="black">'+data+'</font></div>');
                    $('#frmAddStocks')[0].reset();
                    $('#productAddStocksModal').modal('hide');
                    productdataTable.ajax.reload();
